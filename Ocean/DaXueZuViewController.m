...
@interface DaXueZuViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DaXueZuViewController
...
-(void)jiexi
{
    NSString *body=@"http://ahy.cz5u.com/HaiYangBBSService.asmx/GetTwoList";
