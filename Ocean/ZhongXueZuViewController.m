...
@interface ZhongXueZuViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZhongXueZuViewController
...
-(void)jiexi
{
    NSString *body=@"http://ahy.cz5u.com/HaiYangBBSService.asmx/GetThreeList";
