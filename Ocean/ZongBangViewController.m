...
@interface ZongBangViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ZongBangViewController
...
-(void)jiexi
{
    NSString *body=@"http://ahy.cz5u.com/HaiYangBBSService.asmx/GetTotalList";
