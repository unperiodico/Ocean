...
@interface XiaoXueZuViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XiaoXueZuViewController
...
-(void)jiexi
{
    NSString *body=@"http://ahy.cz5u.com/HaiYangBBSService.asmx/GetFourList";
